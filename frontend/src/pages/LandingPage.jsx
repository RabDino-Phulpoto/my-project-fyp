    ...
    >
      ...
      <main className="flex-1">
        <div className="max-w-6xl mx-auto px-4">
          ...
          {/* HERO SECTION */}
          <section className="pt-6 pb-8 md:pt-10 md:pb-12 grid md:grid-cols-2 gap-10 items-center">
            {/* Left: text */}
            <div>
              ...
              <p className="mt-4 text-gray-600 text-sm md:text-base max-w-md">
                AI-powered platform for detecting intracranial aneurysms early and accurately
          ...
          <section
            id="about"
            className="pt-8 pb-12 md:pt-10 md:pb-14 grid md:grid-cols-2 gap-10 items-center"
          >
            <div>
              ...
              <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                IADS leverages advanced artificial intelligence to analyze medical
                imaging and detect intracranial aneurysms at early stages. Our goal is to
                support clinicians with reliable and interpretable AI—not replace their expertise.
              </p>
            </div>
          ...
          {/* FEATURES SECTION */}
          <section id="features" className="pt-8 pb-12 md:pt-12 md:pb-14">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 flex flex-col gap-2">
                ...
                <p className="text-xs md:text-sm text-gray-600">
                  All data is encrypted and stored securely for fully compliant access.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 flex flex-col gap-2">
                ...
                <p className="text-xs md:text-sm text-gray-600">
                  Developed with medical experts and validated on real-world clinical datasets.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="pt-8 pb-12 md:pt-12 md:pb-14">
            <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 text-center mb-8">
              How It Works
            </h2>
            ...
            <div className="grid md:grid-cols-4 gap-6 text-center text-sm md:text-base">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-5 flex flex-col items-center gap-3">
                ...
                <h3 className="font-semibold text-gray-900">Upload Medical</h3>
                <p className="text-xs md:text-sm text-gray-600">
                  Upload your CTA / MRA scan.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm p-5 flex flex-col items-center gap-3">
                ...
                <h3 className="font-semibold text-gray-900">AI Analysis Begins</h3>
                <p className="text-xs md:text-sm text-gray-600">
                  Our algorithms analyze your scan.
                </p>
              </div>
          ...
          {/* CONTACT SECTION */}
          <section id="contact" className="pt-12 pb-16 md:pt-14 md:pb-20 text-center">
